...
// JUST RUNNING A SUBSET OF COMBINATIONS FOR THIS FULLY-RUN EXAMPLE!
// ONLY EVALUATING 4 UPPER HUE (50, 58, 66, 74); 2 LOWER HUE (109, 113); 4 PIXEL SIZE (100, 110, 120, 130)
// TOTAL OF 640 COMBINATIONS, INSTEAD OF 7500
// HAD TO CHANGE "c<1875" TO "c<160" TO REFLECT NEW # OF COMBINATIONS PER PROCESSING METHOD
...
proj_folder = "D:/Projects/ARC_Auto_Count_Project_EXAMPLE_COMPLETE/TrainSet/";
...
merge_folder = "D:/Projects/ARC_Auto_Count_Project_EXAMPLE_COMPLETE/TrainSet/3_MergeRaw/";

// Can only compare to one set of manual counts. Edit folder path appropriately.
// Manual count markers are here:
manual_count_folder = "D:/Projects/ARC_Auto_Count_Project_EXAMPLE_COMPLETE/TrainSet/1_Markers/";
...
for (f=0; f < files.length; f++) {
	if (endsWith(files[f], ".tif")) {
		...
		for (t=0; t < thresholds.length; t++){
			for (lower_hue = 50; lower_hue < 75; lower_hue=lower_hue+8) { // 5 options, range of 50-74, up by 6's
				for (upper_hue = 109; upper_hue < 114; upper_hue=upper_hue+4) { // 3 options, range of 109-113, up by 2's
...
////////////////////////////////////////////////////////////////////
					...
					for (cell_pixel_size = 100; cell_pixel_size < 131; cell_pixel_size = cell_pixel_size + 10) { // 25 options, range of 40-280, up by 10's
						selectWindow("Result of Result of 0");
...
for (c=0; c<160; c++) { //NUMBER OF COMBINATIONS: 5 thresh * 5 lower hue * 3 upper hue * 25 pixel sizes = 1875.
	avg = newArray;
	avg_dif = newArray;
	errors = newArray;
	error_rate = newArray;
...
// Main merged files to be automatically counted are here:
merge_folder = "D:/Projects/ARC_Auto_Count_Project_EXAMPLE_COMPLETE/TrainSet/3_MergeMinimum/";
...
// Main merged files to be automatically counted are here:
merge_folder = "D:/Projects/ARC_Auto_Count_Project_EXAMPLE_COMPLETE/TrainSet/3_MergeGMA/";
